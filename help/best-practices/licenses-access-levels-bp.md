...
description: Explore las recomendaciones de prácticas recomendadas de los expertos de Adobe Workfront sobre la configuración, administración y uso de licencias y niveles de acceso de Workfront.
...
* Documenta lo que puede hacer cada nivel de acceso en el cuadro Descripción.
...
Inicie usuarios con el acceso mínimo que necesitarán para realizar su trabajo. Si no pueden realizar su trabajo debido a derechos de acceso insuficientes, generalmente solicitan acceso adicional. Conceder a los usuarios demasiado acceso de inmediato podría provocar problemas de seguridad. Además, siempre es mejor dar a los usuarios más acceso que quitarlos.
...
El uso compartido de un objeto en todo el sistema se utiliza a menudo como una muleta para permitir a ciertos usuarios ver elementos en Workfront. Esto sucede cuando falta la estructura del grupo de Workfront o cuando los permisos de uso compartido no se comprenden completamente. Cuando los elementos se comparten en todo el sistema, significa que todos pueden ver el elemento que se comparte. Dependiendo del tipo de información que se mantenga en el sistema, esto podría llevar a problemas de privacidad.
...
Al desmarcar la opción por completo, se hace que un usuario, con el permiso para compartir, deba determinar la persona o personas específicas (a través de una empresa, grupo o equipo) con las que desee compartir el objeto.
...
Los administradores del sistema tienen acceso a todo lo que hay en Workfront, incluida la configuración global del sistema. El administrador del sistema controla los grupos de configuración a los que pueden acceder los administradores y solo se aplican a ese grupo específico.



Tener administradores de grupos permite que los administradores del sistema deleguen muchas responsabilidades, lo que les permite centrarse en elementos de imagen más grandes, en lugar de en el mantenimiento diario de Workfront. Los administradores de grupos pueden mantenerse en contacto con las necesidades de sus grupos, lo que proporciona un mejor servicio a los usuarios.
...
Copiar un nivel de acceso existente proporciona una base coherente para nuevos niveles de acceso, lo que garantiza que la configuración inicial sea idéntica. Esto también ahorra tiempo, ya que los administradores del sistema no tendrán que configurar un nivel de acceso desde cero.
...
Además, tener menos niveles de acceso puede facilitar el mantenimiento de un sistema libre de desorden e implementar una estrategia, lo que también puede llevar a una incorporación más rápida cuando las personas se unen a la empresa o cambien de departamento.
