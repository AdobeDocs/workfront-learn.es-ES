---
title: Instalar y utilizar un modelo
description: Descubra cómo un administrador instala un modelo y cómo un usuario lo pone en uso.
activity: use
...
* Cómo seleccionar un modelo y determinar si ya se ha instalado o no. Esto lo puede hacer la mayoría de los usuarios con una licencia Standard.
* Cómo instalar un modelo y compartir los objetos creados por él. Esto requiere los servicios de un administrador del sistema.
* Cómo encontrar y utilizar nuevas plantillas de proyecto creadas mediante la instalación de un modelo.
