...
description: Aprenda a asignar tareas, utilizar diagramas de Gantt y las funciones de ruta crítica, monitorizar proyectos mediante vistas, programar tareas de forma eficaz y aplicar restricciones para una planificación del proyecto óptima.
activity: use
