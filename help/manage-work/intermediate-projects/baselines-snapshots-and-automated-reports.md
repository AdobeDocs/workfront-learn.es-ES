---
title: Seguimiento maestro de proyectos con líneas de base, instantáneas e informes automatizados
description: 'Libere el poder de la visibilidad histórica en Workfront. Aunque Workfront sobresale en mostrar actualizaciones de proyectos en tiempo real, comprender cómo se veían sus tareas en diferentes puntos en el pasado requiere una profundización. En este vídeo, aprenderá tres métodos para rastrear datos de tareas históricos: usando líneas de base, capturando instantáneas y configurando correos electrónicos automatizados de informes de tareas.'
...
# Seguimiento maestro de proyectos con líneas de base, instantáneas e informes automatizados
...
* **Las líneas de base proporcionan puntos de referencia históricos:** las líneas de base capturan el estado del proyecto en hitos clave (por ejemplo, inicio o replanificación importante) y se utilizan para medir el progreso con respecto al plan original.
* **Creación automática y manual de línea de base:** Las líneas de base se crean automáticamente cuando el estado del proyecto cambia a &#39;Actual&#39; y también se pueden crear manualmente. No todos los campos de proyecto se capturan en las líneas de base.
