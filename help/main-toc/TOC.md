...
+ Administración y configuración {#administration-and-setup}
  ...
  + Configurar valores predeterminados del sistema {#configure-system-defaults}
    ...
    + [Configurar la localización definida por el usuario](/help/administration-and-setup/configure-system-defaults/configure-user-defined-localization.md)
  ...
  + Procesos de aprobación y rutas de hitos {#approval-processes-and-milestone-paths}
    ...
    + [Creación de rutas y pasos de hitos](/help/administration-and-setup/approval-processes-and-milestone-paths/creating-milestones.md)
...
+ Administración del trabajo {#manage-work}
  ...
  + Tareas {#tasks}
    ...
    + [Actualizar el estado de las tareas para obtener informes precisos](/help/manage-work/tasks/update-the-task-status.md)
  ...
  + Procesos de aprobación y rutas de hitos {#approval-processes-and-milestone-paths}
    ...
    + [Aplicar rutas de hitos a proyectos y tareas](/help/manage-work/approval-processes-and-milestone-paths/apply-milestones.md)
  ...
  + Finanzas del proyecto para usuarios {#project-finances-users}
    + [Acceso y administración de la información financiera para las finanzas del proyecto](/help/manage-work/project-finances/find-financial-information.md)
...
+ Workfront DAM {#workfront-dam-program}
  ...
  + Metadatos y palabras clave {#metadata-and-keywords}
    + [Introducción de metadatos y palabras clave](/help/workfront-dam/metadata-and-keywords/metadata-introduction.md)
