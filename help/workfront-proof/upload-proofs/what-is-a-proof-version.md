...
Esto “apila” la versión sobre el archivo original, manteniendo un historial de las revisiones, al tiempo que se garantiza que está viendo la última iteración del trabajo. El visualizador de revisiones de Workfront también le permite comparar la última versión con una versión anterior del archivo.
