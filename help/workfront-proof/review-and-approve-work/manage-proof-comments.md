...
![Una imagen de una revisión en el visualizador de revisiones con el icono de indicador resaltado en el comentario y las acciones de revisión disponibles visibles.](assets/manage-comments-1.png)
...
![Una imagen de una revisión en el visualizador de revisiones con la acción de revisión [!UICONTROL tarea pendiente] resaltada en el comentario.](assets/manage-comments-2.png)

Si no ve acciones en la lista de comentarios, su organización no las ha configurado. Póngase en contacto con el administrador del sistema de revisiones si cree que las acciones son algo que su organización debe utilizar.
...
![Una imagen de una revisión en el visualizador de revisiones con el icono de marca de verificación resaltado en el comentario.](assets/manage-comments-4.png)
...
![Una imagen de los filtros de comentario en el visualizador de revisiones con las [!UICONTROL Acciones] y las opciones [!UICONTROL generales] de filtrado resaltadas.](assets/manage-comments-3.png)
