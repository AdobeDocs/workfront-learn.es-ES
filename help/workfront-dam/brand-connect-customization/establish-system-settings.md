...
* **Mostrar este portal en motores de búsqueda?**—¿Desea que la dirección URL de [!UICONTROL Brand Connect] aparezca cuando las personas realicen búsquedas en Internet?
* **Permitir vínculos integrables?**: ¿Pueden provenir de [!UICONTROL Brand Connect] los vínculos integrables? Esto agrega el panel [!UICONTROL Obtener vínculos] al menú [!UICONTROL Compartir] que proporciona vínculos incrustables para el recurso.
* **Habilitar/deshabilitar redes sociales?**: si las redes sociales están habilitadas (marque la casilla), los usuarios pueden mostrar me gusta en los recursos y hacer comentarios al respecto.
* **Habilitar/deshabilitar la descarga y el recuento de visualizaciones?**: cuando está habilitada, los usuarios pueden ver cuántas veces se ha descargado un recurso y cuántos comentarios tiene.
