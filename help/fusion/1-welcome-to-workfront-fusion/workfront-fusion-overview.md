...
Para completar los ejercicios de los tutoriales de aprendizaje de Workfront Fusion, necesitará un entorno de habilitación de Workfront, también denominado &quot;**Prueba de Workfront**&quot; a lo largo de este curso de formación. Si ya tiene una unidad de prueba, le recomendamos una nueva para esta formación.

Solicite una unidad de prueba rellenando [este formulario](https://survey.adobe.com/jfe/form/SV_71xcV8UByyVwgBg). Cuando complete el formulario, le pedirá que proporcione el **correo electrónico del perfil de certificación de Adobe**. Si todavía no dispone de uno, vaya al [sitio de certificación de Adobe](https://certification.adobe.com/#) y cree un perfil de usuario.
