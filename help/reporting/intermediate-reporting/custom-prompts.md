...
description: Descubra qué es un mensaje personalizado, cómo crear un mensaje personalizado mediante el modo de texto y algunos ejemplos que puede utilizar en los informes de [!DNL  Workfront].
activity: use
