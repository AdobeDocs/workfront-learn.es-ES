...
---
# Creación y administración de procesos de aprobación: COMPARTIDO
...
&#x200B;Destaca la flexibilidad de los procesos globales y de un solo uso para administrar las aprobaciones de tareas de forma eficaz.
...
* **Procesos de aprobación globales:** Estos se crean en la sección Configuración > Procesos > Aprobaciones y se pueden activar según estados específicos. Pueden incluir varios aprobadores o aprobaciones organizadas.
* **Proceso de aprobación de un solo uso:** Son específicos de objetos y no se pueden compartir. Se pueden crear desde cero o editando un proceso de aprobación global y convirtiéndolo.
...
* [Creación y administración de procesos de aprobación](/help/administration-and-setup/approval-processes-and-milestone-paths/group-specific-approval-processes.md)
