...
+ Administrar trabajo {#manage-work}
   + Proyectos {#projects}
      ...
      + [Descubra cuatro formas de crear un proyecto](manage-work/projects/understand-other-ways-to-create-projects.md)
...
+ Workfront Goals {#workfront-goals}
   ...
   + Activar sus objetivos {#activate-goals}
      ...
      + [Agregar una actividad y un proyecto a un objetivo](workfront-goals/activate-your-goals/add-an-activity-to-a-goal.md)
